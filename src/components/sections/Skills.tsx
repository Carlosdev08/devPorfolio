      ...
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {skillCategories.map((category, categoryIndex) => {
              ...
              return (
                <div
                  key={category.title}
                  className="relative group bg-card rounded-xl p-6 border border-border/50 hover:shadow-medium hover:scale-105 transition-all duration-300"
                >
                  {/* Category header */}
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {category.badge && (
                      <span className="ml-auto px-2 py-0.5 text-[10px] rounded-full bg-accent/15 text-accent">
                        {category.badge}
                      </span>
                    )}
                  </div>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-card/80 backdrop-blur rounded-full border border-border/50">
